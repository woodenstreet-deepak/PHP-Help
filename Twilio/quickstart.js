$(function() {
    ...
    $.getJSON('https://inchworm-bat-5619.twil.io/capability-token')
        //Paste URL HERE
        .done(function(data) {
            log('Got a token.');
            ...
            Twilio.Device.incoming(function(conn) {
                ...
                $("#incomingPhone").text(conn.parameters.From);
                // $("#txtPhoneNumber").text(conn.parameters.From)

                // $('#modal-incomming-call').modal('show')

                $('#incomingPhoneReject').bind('click', function() {
                    // $('.modal').modal('hide')
                ...
                $('#incomingPhoneAccept').bind('click', function() {
                    // $('.modal').modal('hide')
                    $("#incoming-call-controls").hide();
                    log("Accepted call ...");
                    conn.accept();
